...
import { ArrowLeft, MapPin, Clock, Star, Home } from "lucide-react";
            ...
            <div key={item.id} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/handicrafts/${item.id}`} className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors">
                    View Details
                  </Link>
                </div>
              </div>
